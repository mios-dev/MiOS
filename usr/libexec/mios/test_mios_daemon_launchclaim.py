# AI-hint: !/usr/bin/env python3 Standalone unit test for the mios-daemon launch-claim detector after the NO-HARDCODE cutover.
# AI-doc: usr/share/doc/mios/manual/_harvest/usr_libexec_mios_test_mios_daemon_launchclaim_py.md
