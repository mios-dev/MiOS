# Fork notes by s-h-a-d-o-w

Really no substantial improvement, just some dev workflow things that would make it easier to transition to modern TS. Have no time for that at the moment, unfortunately.
