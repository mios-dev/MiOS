...
## G-TASK 1 — Pod consolidation (WS-C) — the main one
...
## G-TASK 2 — WS-0B port collapse (build-time render) — the still-open one
...
## G-TASK 3 — Docs honesty reconciliation (WS-G)
