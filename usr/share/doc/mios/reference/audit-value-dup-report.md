...
| 11 | `MIOS_EDITIONS_MIOS_*_MINI_*` = `MIOS_MINI_*` | 8 | 6 | 0 | Edition overlays re-emit the base MINI keys. |
...
| `0000:01:00.0` | 4 | true-alias | MIOS_EDITIONS_MIOS_MINI_GPU_ASSIGNMENTS_MIOS_GUEST, MIOS_EDITIONS_MIOS_XBOX_ARM_MINI_GPU_ASSIGNMENTS_MIOS_GUEST, MIOS_EDITIONS_MIOS_XBOX_MINI_GPU_ASSIGNMENTS_MIOS_GUEST, MIOS_MINI_GPU_ASSIGNMENTS_MIOS_GUEST |
...
| `static` | 4 | true-alias | MIOS_EDITIONS_MIOS_MINI_GPU_ARBITRATION, MIOS_EDITIONS_MIOS_XBOX_ARM_MINI_GPU_ARBITRATION, MIOS_EDITIONS_MIOS_XBOX_MINI_GPU_ARBITRATION, MIOS_MINI_GPU_ARBITRATION |
...
| `/mnt/m/Programs/Everything/es.exe,/mnt/c/Prog…` | 2 | true-alias | MIOS_EVERYTHING_CLI, MIOS_PATHS_EVERYTHING_CLI |
...
| `/var/lib/mios/hermes-tail,/var/lib/mios/deleg…` | 2 | true-alias | MIOS_FS_WATCHER_DIRS, MIOS_FS_WATCHER_WATCH_DIRS |
| `/var/lib/mios/hermes-tail/frontier/frontier.j…` | 2 | true-alias | MIOS_A2O_STREAM_PATH, MIOS_FRONTIER_STREAM_PATH |
...
| `85` | 2 | distinct-configurable-fact | MIOS_MINI_GUEST_CPU_PERCENT, MIOS_MINI_GUEST_RAM_PERCENT |
...
| `approx.,Approx.,e.g.,i.e.,vs.,etc.,U.S.,U.K.,…` | 2 | true-alias | MIOS_SENTENCE_ABBREVIATIONS, MIOS_VERITY_SENTENCE_ABBREVIATIONS |
| `attempt to launch and verify,launch and verif…` | 2 | true-alias | MIOS_LAUNCH_RETRY_PHRASES, MIOS_ROUTING_LAUNCH_RETRY_PHRASES |
...
| `didn't launch,did not launch,didn't open,did …` | 2 | true-alias | MIOS_LAUNCH_FOLLOWUP_PHRASES, MIOS_ROUTING_LAUNCH_FOLLOWUP_PHRASES |
...
| `for me please,on my desktop,on the desktop,ri…` | 2 | true-alias | MIOS_LAUNCH_FILLER_PHRASES, MIOS_ROUTING_LAUNCH_FILLER_PHRASES |
...
| `https://api.github.com/repos/ful1e5/Bibata_Cu…` | 2 | true-alias | MIOS_ENV_MIOS_URL_BIBATA_API, MIOS_URL_BIBATA_API |
| `https://copr.fedorainfracloud.org/coprs/ublue…` | 2 | true-alias | MIOS_ENV_MIOS_URL_UBLUE_REPO, MIOS_URL_UBLUE_REPO |
| `https://github.com/ful1e5/Bibata_Cursor/relea…` | 2 | true-alias | MIOS_ENV_MIOS_URL_BIBATA_DL, MIOS_URL_BIBATA_DL |
| `https://github.com/ful1e5/Bibata_Cursor/relea…` | 2 | true-alias | MIOS_ENV_MIOS_URL_BIBATA_SUM, MIOS_URL_BIBATA_SUM |
| `https://github.com/terrapkg/subatomic-repos/r…` | 2 | true-alias | MIOS_ENV_MIOS_URL_TERRA_REPO, MIOS_URL_TERRA_REPO |
| `https://packagecloud.io/crowdsec/crowdsec/con…` | 2 | true-alias | MIOS_ENV_MIOS_URL_CROWDSEC_REPO, MIOS_URL_CROWDSEC_REPO |
| `https://pkgs.tailscale.com/stable/fedora/tail…` | 2 | true-alias | MIOS_ENV_MIOS_URL_TAILSCALE_REPO, MIOS_URL_TAILSCALE_REPO |
| `in,and,then,with,on,to` | 2 | true-alias | MIOS_COMPOUND_CONNECTIVES, MIOS_ROUTING_COMPOUND_CONNECTIVES |
| `limit,count,timeout,port,every,concurrency,ma…` | 2 | true-alias | MIOS_INTEGER_PARAM_KEYWORDS, MIOS_ROUTING_INTEGER_PARAM_KEYWORDS |
...
| `network-online.target,mios-hermes-browser.ser…` | 2 | distinct-configurable-fact | MIOS_PODS_MIOS_WEBTOOLS_AFTER, MIOS_PODS_MIOS_WEBTOOLS_WANTS |
...
| `org.gtk.Gtk3theme.adw-gtk3-dark,org.gtk.Gtk3t…` | 2 | true-alias | MIOS_DESKTOP_FLATPAKS, MIOS_FLATPAKS |
...
| `quote,read,tell,summarise,summarize,what is,w…` | 2 | true-alias | MIOS_BROWSER_ACTION_VERBS, MIOS_ROUTING_BROWSER_ACTION_VERBS |
| `qwen25` | 2 | distinct-configurable-fact | MIOS_LANES_SGLANG_TOOL_CALL_PARSER, MIOS_SGLANG_TOOL_PARSER |
| `remember,note,save,keep in mind,don't forget,…` | 2 | true-alias | MIOS_REMEMBER_TRIGGER_PHRASES, MIOS_ROUTING_REMEMBER_TRIGGER_PHRASES |
| `search,look up,google,find,search the web,sea…` | 2 | true-alias | MIOS_ROUTING_WEB_SEARCH_TRIGGER_PHRASES, MIOS_WEB_SEARCH_TRIGGER_PHRASES |
...
| `weather,forecast,near me,nearby,near here,aro…` | 2 | true-alias | MIOS_LOCATION_SENSITIVE_PHRASES, MIOS_ROUTING_LOCATION_SENSITIVE_PHRASES |
...
every `true-alias` / `intentional-many-to-one` group is <=8 keys and shown in full).

```tsv
value	count	class	keys
(EMPTY)	774	unset-default	MIOS_A2A_;MIOS_A2A_AGENT_NAME;MIOS_A2A_CLIENT_DISABLED;MIOS_A2A_DEFAULT_MODEL;MIOS_A2A_DISCOVER_URLS;MIOS_A2A_PRINCIPAL_MODE;MIOS_A2A_STREAM;MIOS_A2A_TAILNET_DISCOVER;MIOS_A2A_TASKS_MAX;MIOS_A2O_;MIOS_A2O_AGY_EFFORT_FLAG;MIOS_A2O_AUTO;MIOS_A2O_ENGINE;MIOS_A2O_GEMINI_EFFORT_FLAG;MIOS_A2O_WORK;MIOS_ADMIT_ENABLE;MIOS_ADMIT_LOAD_CEIL;MIOS_ADMIT_MAX_WAIT;MIOS_ADMIT_MEM_PCT;MIOS_AGENT;...(+754 more)
true	193	distinct-configurable-fact	MIOS_A2O_LANE_B_PREFER_FALLBACK;MIOS_ACCOUNTS_DB_BACKED;MIOS_AGENTS_AI_LOCAL_HEALTH_GATE;MIOS_AGENTS_HERMES_HEALTH_GATE;MIOS_AGENTS_MIOS_DAEMON_AGENT_FANOUT;MIOS_AGENTS_MIOS_DAEMON_AGENT_HEALTH_GATE;MIOS_AGENTS_OPENCODE_ENABLED;MIOS_AGENTS_OPENCODE_FANOUT;MIOS_AGENTS_OPENCODE_HEALTH_GATE;MIOS_AGENTS__DEFAULTS_ENABLED;MIOS_AGENTS__DEFAULTS_FANOUT;MIOS_AGENT_PIPE_CLIENT_TOOLS_PASSTHROUGH;MIOS_AGENT_PIPE_ENABLE;MIOS_AGENT_PIPE_QUALITY_CHECK_EMPTY;MIOS_AGENT_PIPE_QUALITY_CHECK_JSON;MIOS_AGENT_PIPE_QUALITY_CHECK_PUNT;MIOS_AGENT_PIPE_REFLEXION_ENABLE;MIOS_ANTIFAB_ENABLE;MIOS_AUDIT_CHAIN_ENABLE;MIOS_BRANDING_DASHBOARD_SHOW_FASTFETCH;...(+173 more)
false	109	distinct-configurable-fact	MIOS_A2A_COUNCIL;MIOS_A2A_MDNS_ADVERTISE;MIOS_A2A_MDNS_DISCOVERY;MIOS_A2A_ROUTE_ON_CARD_SKILLS;MIOS_A2O_STREAM_REASONING;MIOS_ACCOUNTS_DB_RENDER_PREFS;MIOS_ADMISSION_MULTIBLADE_ENABLE;MIOS_ADMISSION_TENANT_QUOTA_ENABLE;MIOS_AGENTS_AI_LOCAL_DEFAULT;MIOS_AGENTS_HERMES_DEFAULT;MIOS_AGENTS_HERMES_FANOUT;MIOS_AGENTS_MIOS_DAEMON_AGENT_DEFAULT;MIOS_AGENTS_OPENCODE_DEFAULT;MIOS_AGENTS__DEFAULTS_DEFAULT;MIOS_AGENTS__DEFAULTS_HEALTH_GATE;MIOS_AGENTS__DEFAULTS_RESEARCH_ONLY;MIOS_AGENTS__DEFAULTS_TRUST_MTLS;MIOS_AGENTS__DEFAULTS_TRUST_REQUIRE_SIGNED_PRINCIPAL;MIOS_AGENT_PIPE_COUNCIL_AGGREGATOR_BYPASS;MIOS_AGENT_PIPE_COUNCIL_DIVERSITY_GATE;...(+89 more)
2	22	distinct-configurable-fact	MIOS_AGENT_PIPE_NO_PROGRESS_WINDOW;MIOS_AGENT_PIPE_REFLEXION_LIMIT;MIOS_DEV_VM_CPU_RESERVE_MIN;MIOS_DISPATCH_AUTONOMY_MAX_DISPATCH_DEPTH;MIOS_DISPATCH_DEFAULT_HOP_BUDGET;MIOS_DISPATCH_LANE_CONCURRENCY_CPU;MIOS_DISPATCH_LANE_CONCURRENCY_GPU;MIOS_DISPATCH_SWARM_MAX_CPU_NODES;MIOS_FIND_CATEGORY_PRIORITY_WINDOWS_GUI;MIOS_FIND_RANKER_FUZZY_MAX_EDIT_DISTANCE;MIOS_FINETUNE_BATCH_SIZE;MIOS_FINETUNE_EPOCHS;MIOS_FIRECRAWL_WORKERS;MIOS_SCHED_COMPLEXITY_HINTS_DIVISOR;MIOS_SCHED_SCORE_ROUND_NDIGITS;MIOS_SCHED_URGENCY_LOW;MIOS_SELFIMPROVE_PASSHAT_K;MIOS_SERVICES_WEBTOOLS_FIRECRAWL_WORKERS;MIOS_SKILLS_MIN_LENGTH;MIOS_WEB_RESEARCH_ANCHOR_WEIGHT;...(+2 more)
0	19	distinct-configurable-fact	MIOS_ADMISSION_TENANT_MAX_CONCURRENCY;MIOS_AGENTS__DEFAULTS_TIMEOUT_S;MIOS_AI_TAG_MAX_UNCONFORMING;MIOS_COCKPIT_IDLE_TIMEOUT;MIOS_CONV_INFERENCE_LLAMA_CACHE_REUSE_TOKENS;MIOS_DISPATCH_KV_PAGING_SLOT;MIOS_GOSSIP_INTERVAL_MIN;MIOS_OS_CONTROL_DEFAULT_MONITOR;MIOS_OS_CONTROL_EDGE_MARGIN_PX;MIOS_PGVECTOR_POOL_MIN;MIOS_PG_POOL_MIN;MIOS_PORTS_STACK_ID;MIOS_PORT_STACK_ID;MIOS_SCHEDULER_PRIORITY_LEVELS;MIOS_SELFIMPROVE_INTERVAL_MIN;MIOS_TERMINAL_RIGHT_MARGIN;MIOS_TTYD_MAX_CLIENTS;MIOS_WSL2_DESKTOP_COMPAT_MOZ_WAYLAND;MIOS_WSLG_MOZ_WAYLAND
3	19	distinct-configurable-fact	MIOS_AGENT_PIPE_MAX_CONSECUTIVE_FAILURES;MIOS_ANTIFAB_MIN_ENTITIES;MIOS_DAEMON_ESCALATION_MAX_ATTEMPTS;MIOS_DISPATCH_AGENT_CONCURRENCY;MIOS_DISPATCH_FANOUT_MAX;MIOS_DISPATCH_LANE_CONCURRENCY;MIOS_DISPATCH_RERANK_FANOUT;MIOS_DISPATCH_SWARM_MAX_WIDTH;MIOS_FIND_CATEGORY_PRIORITY_LINUX_FLATPAK;MIOS_GOSSIP_FANOUT;MIOS_PKG_LOOKUP_MAX_ALIAS_RESULTS;MIOS_REFINE_DISPATCH_ARG_MAX_WORDS;MIOS_RELIABILITY_PASS_AND_K_COUNT;MIOS_SELFIMPROVE_MAX_PROPOSALS_PER_PASS;MIOS_SKILLS_MIN_SUCCESS_SAMPLES;MIOS_SKILLS_MIN_SUPPORT;MIOS_VERITY_ANTIFAB_MIN_ENTITIES;MIOS_WEB_RESEARCH_MAX_ATTEMPTS;MIOS_WEB_RESEARCH_PASSES
mios	19	distinct-configurable-fact	MIOS_AUTH_PASSWORD;MIOS_CEPHFS_TENANT_ID;MIOS_DEFAULT_HOST;MIOS_DEFAULT_PASSWORD;MIOS_DEFAULT_USER;MIOS_FIRECRAWL_BULL_KEY;MIOS_HOSTNAME;MIOS_IDENTITY_DEFAULT_PASSWORD;MIOS_IDENTITY_HOSTNAME;MIOS_IDENTITY_NAME;MIOS_IDENTITY_USERNAME;MIOS_PGVECTOR_DB;MIOS_PGVECTOR_PASS;MIOS_PG_DB;MIOS_PG_PASS;MIOS_PG_USER;MIOS_SERVICES_WEBTOOLS_FIRECRAWL_BULL_KEY;MIOS_STORAGE_CEPHFS_TENANT_ID;MIOS_USER
latest	18	distinct-configurable-fact	MIOS_ADGUARD_VERSION;MIOS_BIB_ALPINE_VERSION;MIOS_CAT_VENTOY_VERSION;MIOS_CODE_SERVER_VERSION;MIOS_CROWDSEC_VERSION;MIOS_GUACAMOLE_VERSION;MIOS_GUACD_VERSION;MIOS_HERMES_VERSION;MIOS_IMAGE_TAG;MIOS_OPENCODE_VERSION;MIOS_OTELCOL_VERSION;MIOS_POSTGRES_VERSION;MIOS_PXE_HUB_VERSION;MIOS_SEARXNG_VERSION;MIOS_SGLANG_VERSION;MIOS_SYS_VERSION;MIOS_VALKEY_VERSION;MIOS_VLLM_VERSION
1	16	distinct-configurable-fact	MIOS_BUDGET_AUTONOMOUS_MAX_INFLIGHT;MIOS_CONV_IMAGE_RECHUNK_FORMAT_VERSION;MIOS_CONV_INFERENCE_LLAMA_PARALLEL_SLOTS;MIOS_DAEMON_CRON_MAX_CONCURRENT;MIOS_DISPATCH_DAG_NODE_RETRY;MIOS_DISPATCH_FANOUT_MIN;MIOS_DISPATCH_REQUEST_CANCEL_ENABLE;MIOS_FIND_CATEGORY_PRIORITY_WINDOWS_APP;MIOS_FIND_CATEGORY_PRIORITY_WINDOWS_BROWSER;MIOS_KNOWLEDGE_EVICT_MIN_ACCESS;MIOS_PGVECTOR_HNSW_SCAN_MEM_MULTIPLIER;MIOS_PG_HNSW_SCAN_MEM_MULTIPLIER;MIOS_SCHEDULER_MAX_PREEMPT_DEPTH;MIOS_SCHED_COMPLEXITY_BASE;MIOS_WEB_RESEARCH_DIGIT_WEIGHT;MIOS_WEB_RESEARCH_SEG_BASE
4	14	distinct-configurable-fact	MIOS_CEPHFS_MDS_CACHE_MEMORY_LIMIT_GIB;MIOS_CONV_GATEWAY_WORKER_CONCURRENCY;MIOS_DEV_VM_MEMORY_RESERVE_GB;MIOS_DISPATCH_COUNCIL_MAX;MIOS_DISPATCH_ENDPOINT_CONCURRENCY;MIOS_DISPATCH_KV_FORK_MAX_BRANCHES;MIOS_DISPATCH_LANE_CONCURRENCY_GPU0;MIOS_DISPATCH_RR_MAX_SUSPENDED;MIOS_DISPATCH_STABLE_PREFIX_TAIL;MIOS_FIND_CATEGORY_PRIORITY_LINUX_RPM_GUI;MIOS_FIND_RANKER_FUZZY_MIN_TOKEN_LEN;MIOS_FINETUNE_SEEDS_PER_CAPABILITY;MIOS_SCHEDULER_MAX_SUSPENDED;MIOS_STORAGE_CEPHFS_MDS_CACHE_MEMORY_LIMIT_GIB
hash	14	distinct-configurable-fact	MIOS_TEMPLATES_AUTOMATION_STEP_COMMENT;MIOS_TEMPLATES_BASH_COMMENT;MIOS_TEMPLATES_BASH_TOOL_COMMENT;MIOS_TEMPLATES_BASH_VERB_COMMENT;MIOS_TEMPLATES_DRIFT_CHECK_COMMENT;MIOS_TEMPLATES_JSON_SCHEMA_COMMENT;MIOS_TEMPLATES_POWERSHELL_COMMENT;MIOS_TEMPLATES_PYTHON_MODULE_COMMENT;MIOS_TEMPLATES_PYTHON_TEST_COMMENT;MIOS_TEMPLATES_PYTHON_TOOL_COMMENT;MIOS_TEMPLATES_QUADLET_COMMENT;MIOS_TEMPLATES_SYSTEMD_UNIT_COMMENT;MIOS_TEMPLATES_TOML_CONFIG_COMMENT;MIOS_TEMPLATES_YAML_COMMENT
8	10	distinct-configurable-fact	MIOS_DISPATCH_BATCH_MAX_SIZE;MIOS_DISPATCH_FANOUT_SELECT_TIMEOUT_S;MIOS_DISPATCH_MAX_SOURCES;MIOS_FINETUNE_GRAD_ACCUM;MIOS_OS_CONTROL_TILE_GAP_PX;MIOS_PGVECTOR_POOL_MAX;MIOS_PG_POOL_MAX;MIOS_PREFLIGHT_MIN_RAM_GB;MIOS_SCHED_URGENCY_DISPATCH_FLOOR;MIOS_SKILLS_MAX_LENGTH
mios-heavy	10	distinct-configurable-fact	MIOS_AGENTS_HERMES_CPU_MODEL;MIOS_AGENTS_HERMES_MODEL;MIOS_AGENTS_MIOS_DAEMON_AGENT_MODEL;MIOS_NODES_LOCAL_CPU_MODEL;MIOS_NODES_LOCAL_DGPU_MODEL;MIOS_NODES_LOCAL_LLAMASWAP_MODEL;MIOS_NODES_LOCAL_SGLANG_MODEL;MIOS_NODES_LOCAL_VLLM_MODEL;MIOS_SGLANG_SERVED_NAME;MIOS_VLLM_SERVED_NAME
12	8	distinct-configurable-fact	MIOS_AI_RAM_FLOOR_GB;MIOS_BUILD_AI_RAM_FLOOR_GB;MIOS_DISPATCH_CUA_MAX_STEPS;MIOS_DISPATCH_DEEPEN_ITERS;MIOS_DISPATCH_SLOW_LANE_TOOL_CAP;MIOS_FORGE_VERSION;MIOS_VM_WIN11_VCPUS;MIOS_WEB_RESEARCH_SLUG_MIN_LEN
5	8	distinct-configurable-fact	MIOS_AGENT_PIPE_QUALITY_MIN_LENGTH;MIOS_AGENT_PIPE_REPLAN_MAX;MIOS_FIND_CATEGORY_PRIORITY_AGENT_CLI;MIOS_KNOWLEDGE_HOT_THRESHOLD;MIOS_MEMORY_TOOL_RESULT_TTL_TURNS;MIOS_RELIABILITY_PASS_AND_K_DGM_COUNT;MIOS_SCHED_URGENCY_DEFAULT;MIOS_SELFIMPROVE_MIN_SAMPLES
auto	8	distinct-configurable-fact	MIOS_BOOTSTRAP_MODE;MIOS_COMPUTER_USE_CAPTURE_BACKEND;MIOS_COMPUTER_USE_INPUT_BACKEND;MIOS_ENHANCED_SESSION_RESOLUTION;MIOS_FINETUNE_DEVICE;MIOS_FINETUNE_LOAD_IN_4BIT;MIOS_FINETUNE_TARGET_MODULES;MIOS_POWER_UPS_PORT
gpu	8	distinct-configurable-fact	MIOS_AGENTS_HERMES_LANE;MIOS_AGENTS_OPENCODE_LANE;MIOS_AGENTS__DEFAULTS_LANE;MIOS_NODES_LOCAL_CPU_LANE;MIOS_NODES_LOCAL_DGPU_LANE;MIOS_NODES_LOCAL_LLAMASWAP_LANE;MIOS_NODES_LOCAL_SGLANG_LANE;MIOS_NODES_LOCAL_VLLM_LANE
