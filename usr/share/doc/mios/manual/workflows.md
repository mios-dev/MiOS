<!-- AI-hint: Manual pages distilled from the source comments of workflows, sanitized, each passage anchored to the comment it came from. -->
...
<!-- mios-src:1328de9fd76a from .forgejo/workflows/build-mios.yml:33-38 -->
...
<!-- mios-src:9b1abfdb404e from .forgejo/workflows/build-mios.yml:114-121 -->
...
<!-- mios-src:147551906b1c from .forgejo/workflows/build-mios.yml:151-154 -->
...
<!-- mios-src:c8be1fb9930b from .forgejo/workflows/build-mios.yml:170-174 -->
...
<!-- mios-src:c90f747b0a61 from .github/workflows/mios-ci.yml:25-43 -->
...
<!-- mios-src:6b7280f004e5 from .github/workflows/mios-ci.yml:112-120 -->
...
<!-- mios-src:9084b8acca81 from .github/workflows/mios-ci.yml:124-131 -->
...
<!-- mios-src:0e4256b66c2a from .github/workflows/mios-ci.yml:166-172 -->
...
<!-- mios-src:9565dcccef24 from .github/workflows/mios-ci.yml:218-225 -->
...
<!-- mios-src:32d6ab8c2bce from .github/workflows/mios-ci.yml:227-233 -->
...
<!-- mios-src:b896b941f929 from .github/workflows/mios-ci.yml:239-250 -->
...
<!-- mios-src:488fc6bcd3a7 from .github/workflows/mios-ci.yml:262-269 -->
...
<!-- mios-src:feb6b6ba127c from .github/workflows/mios-ci.yml:292-333 -->
...
<!-- mios-src:6ec74752970a from .github/workflows/mios-ci.yml:379-394 -->
...
<!-- mios-src:617b0a013ef0 from .github/workflows/mios-ci.yml:498-504 -->
...
<!-- mios-src:9565dcccef24 from .github/workflows/mios-ci.yml:530-537 -->
...
<!-- mios-src:32d6ab8c2bce from .github/workflows/mios-ci.yml:539-545 -->
...
<!-- mios-src:c5329a266c25 from .github/workflows/mios-ci.yml:572-577 -->
...
AI-related: /etc/mios/install.env, /usr/lib/mios/agent-pipe/server.py, /usr/lib/mios/agent-pipe, /usr/libexec/mios/mios-bench, mios-ci, mios-dev, mios-pc-control, mios-launcher-daemon, mios-flatpak-icon-sanitize, mios-wsl-interop-priority

<!-- mios-src:1143953e3ced from .github/workflows/mios-ci.yml:1-2 -->
