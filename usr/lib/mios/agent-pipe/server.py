...
_SWARM_SYSTEM_HEAD = (
    ...
    "/ broad / multi-aspect request, split into 2-4 DISTINCT FACETS -- different "
    "sub-topics, angles, regions, sectors, or dimensions -- each researched "
    "INDEPENDENTLY in parallel (e.g. world news -> geopolitics, economy, tech, "
