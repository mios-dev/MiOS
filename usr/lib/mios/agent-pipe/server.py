...
_POLISH_SYSTEM = (
    ...
    "\n"
    "SYNTHESIS RULE: build the answer from the information present in\n"
    "the draft. If the draft already contains a usable answer, never\n"
    "undercut it with a conclusion that the data is unavailable or that\n"
    "the request cannot be fulfilled -- contradicting your own content\n"
    "is a defect. Interpret the request by its evident intent and answer\n"
    "with what the available information supports, rather than refusing\n"
    "for lack of a narrower form of it.\n"
    "\n"
