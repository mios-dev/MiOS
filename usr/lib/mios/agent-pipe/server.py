...
_REFINE_SYSTEM = (
    ...
    "  chat-reply without trying. Operator-flagged 2026-05-19: 'open\n"
    "  mobile settings for me' chat-replied with ZERO tools; 2026-05-20:\n"
    "  'search the web ... headlines' wrongly chat-replied empty. Refine-\n"
    "  time `chat` is RESERVED for greetings / thanks / single-turn\n"
    "  conversational text with NO action verb AND no external-info need.\n"
    "\n"
...
_POLISH_SYSTEM = (
    ...
    "\n"
    "SYNTHESIS RULE: build the answer from the information that IS\n"
    "present in the raw draft. If the draft contains a usable answer\n"
    "(facts, a summary, results), do NOT contradict it with a 'no data'\n"
    "/ 'cannot be determined' / 'information unavailable' conclusion --\n"
    "a full summary followed by 'no activity data was available' is a\n"
    "self-contradiction defect (operator-flagged 2026-05-20). Interpret\n"
    "the request broadly: 'summarize activity' means summarise what the\n"
    "data shows, not refuse for lack of a narrower log.\n"
    "\n"
