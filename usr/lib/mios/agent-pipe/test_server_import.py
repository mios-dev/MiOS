...
_EXTRACTED = {
    "mios_config": ["_toml_section", "_cfg_num", "PORT", "_STACK_MODEL"],
    "mios_provider_translate": ["_scrub_schema", "_oai_msgs_to_anthropic"],
    "mios_sse": ["_sse_chunk", "_sse_status", "_stream_answer", "_iter_answer_chunks"],
    "mios_dci": ["run_dci_flow", "critic_then_maybe_flow"],
    "mios_endpoints": ["_endpoint_is_ollama", "_endpoint_is_llamacpp"],
    "mios_grounding": ["_env_grounding", "_env_block", "_host_timezone", "_current_year"],
    "mios_verity": ["polish_response", "_strip_ungrounded_figures", "_clarify_question"],
    ...
    "mios_fanout": ["_pick_fanout_agents"],
    "mios_routing": ["_load_routing_domains", "_load_routing_phrases",
                     "_load_launch_fillers", "_deterministic_action_route"],
    "mios_agentreg": ["_load_agent_registry", "_load_node_pool", "_build_agent_engines",
                      "_agent_lane", "_render_agent_catalog", "_role_system",
                      "_dedup_pool_by_target"],
    "mios_knowledge": ["_store_knowledge", "_recall_knowledge", "_recency_mult",
                       "_rls_owner", "_recall_agent_memory", "kg_lookup"],
    "mios_refine": ["refine_intent", "_salvage_refine_dispatch", "_REFINE_SYSTEM",
                    "_critic_refine_agent"],
    "mios_planner": ["decompose_intent", "_topological_order", "_dag_levels", "_PLANNER_SYSTEM"],
    "mios_toolexec": ["_exec_tool_calls", "_rescue_tool_calls", "_cap_verb_result",
                      "_format_tool_error", "_record_mcp_tool_call"],
    "mios_agent_call": ["_call_agent_complete", "_call_agent_complete_inner",
    ...
    "mios_secondary_loop": ["_v1_secondary_tool_loop", "_ollama_secondary_tool_loop",
                            "_daemon_diagnose", "_TOOL_NUDGE", "_REPLAN_NUDGE",
                            "_tool_call_sig", "_looks_like_disclaimer",
                            "_tmsgs_indicate_failure", "_DISCLAIM_MARKERS"],
    "mios_web_research": ["_web_research_enrich", "_is_port_open",
    ...
    # re.Pattern reports __module__ == 're', which the origin check can't attribute.
    "mios_policy": ["_perm_rank", "_effective_perm", "_agent_rbac_filter",
                    "_dispatch_pdp_reason"],
    "mios_firewall": ["_is_external_url", "_classify_verb_taint",
                      "_session_is_tainted"],
    "mios_hitlflow": ["_action_hash", "_pending_hash", "_hitl_gate",
    ...
    "mios_dag_exec": ["execute_dag", "_execute_dag_node",
                      "_execute_dag_bounded", "_execute_dag_emitting"],
    "mios_swarm": ["_agent_dag_from_tasks", "_respond_agent_dag",
                   "_plan_swarm", "_expand_facets"],
    "mios_native_loop": ["_respond_native_loop_direct", "_respond_local_state",
                         "_format_local_state", "_formulate_web_query",
                         "_formulate_compute_snippet"],
    "mios_oscontrol": ["_respond_os_control", "_verify_os_action", "_window_diff",
                       "_render_os_control_verbs"],
    "mios_vision": ["_vision_complete", "_has_client_tools", "_client_tools_complete"],
    "mios_worker_tools": [],  # populated below if the module exposes stable names
    "mios_toolsearch": ["_tool_embedding", "_ensure_verb_embeddings",
    ...
    "mios_portal": ["_portal_authed", "_portal_token_ok", "_discover_portal_services",
                    ...
                    "portal_page_logic"],
    "mios_a2a": ["_build_agent_card", "_a2a_jsonrpc_dispatch", "_a2a_verify_principal",
    ...
    "mios_a2a_client": ["_a2a_load_peers", "_a2a_send_message_to_peer",
                        "_a2a_extract_text", "_a2a_self_peer_url",
                        "_a2a_fetch_card", "_a2a_tailnet_candidates"],
    "mios_a2a_principal": ["_passport_canonical_json", "_passport_op_hash",
    ...
    "mios_mcp": ["_mcp_call_tool", "_mcp_render_headers", "_McpStdioClient",
    ...
    "mios_http_caps": ["_skill_to_mcp_resource", "_recipe_to_mcp_resource",
    ...
    "mios_chat": ["chat_completions_logic", "responses_api_logic",
    ...
    "mios_cua": ["v1_computer_use_logic", "_cua_extract_png", "_cua_screenshot_uri",
                 "_cua_vlm_json", "_cua_loop"],
    "mios_clusterhealth": ["cluster_health_logic", "scheduler_state_logic",
                           "health_logic", "_probe_one_endpoint",
                           "_lane_sched_stats", "_kernel_managers_detail"],
    "mios_verbcatalog": ["_load_verb_catalog", "_resolve_verb_key",
                         "_verb_to_openai_tool"],
    "mios_turn": ["_extract_last_user_text", "_pick_agent", "_live_agent_names"],
    "mios_lanes_resolver": ["_pick_tool_backend", "_lane_resolver", "_heavy_lane_up"],
    "mios_sched": ["PriorityGate", "_lane_tool_cap", "_agent_offload_engine",
                   "_resolve_autonomous_priority", "_sched_priority", "_lane_sem_key"],
    "mios_promptfmt": ["_council_role_lens", "_format_satisfaction_block", "_format_tool_history",
                       "_build_agent_hint", "_multi_task_preamble"],
    "mios_tokenize": ["_usage_estimate"],
    "mios_classify": ["classify_intent", "_route_domain"],
