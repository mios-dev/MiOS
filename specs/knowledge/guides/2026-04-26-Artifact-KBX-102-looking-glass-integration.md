...
# MiOS-Build v0.1.4 - Looking Glass Integration

## What's New

The MiOS-Build installation script has been updated to version **v0.1.4** with full Looking Glass support for ultra-low latency GPU passthrough to Windows VMs!

### Key Changes

#### 1. **Upstream VirtIO ISO Integration**
- **Previous**: Used standard virtio-win ISO without IVSHMEM driver
- **New**: Downloads upstream virtio-win ISO (`v0.1.4`) that includes:
...
**URL**: `https://fedorapeople.org/groups/virt/virtio-win/direct-downloads/upstream-virtio/virtio-win-v0.1.4.iso`  
