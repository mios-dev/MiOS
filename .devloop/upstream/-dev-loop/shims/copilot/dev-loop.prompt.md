...
---
Load the `dev-loop` skill (`.github/skills/dev-loop/SKILL.md`) and execute its lifecycle (§1) for this objective: ${input:objective:Objective, or lanes:<path/to/lanes.json>}
