...
| Tracked files | 3,312 | The reading surface. |
| Tracked size | 203 MB | Two vendored assets are most of it. |
| Shell / Python / PowerShell / Rust | 42k / 197k / 25k / 27k lines | Law 14 makes Rust the native tier; PowerShell currently outweighs it 0.9x. |
| Drift checks | 218 | Falsifiability audited per check, not assumed. |
