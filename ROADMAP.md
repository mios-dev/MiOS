...
| Tracked files | 3,368 | The reading surface. |
| Tracked size | 206 MB | Two vendored assets are most of it. |
| Shell / Python / PowerShell / Rust | 46k / 202k / 25k / 31k lines | Law 14 makes Rust the native tier; PowerShell currently outweighs it 0.8x. |
