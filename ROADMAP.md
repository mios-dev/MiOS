...
| Tracked files | 3,072 | The reading surface. |
| Tracked size | 201 MB | Two vendored assets are most of it. |
| Shell / Python / PowerShell / Rust | 41k / 188k / 25k / 20k lines | Law 14 makes Rust the native tier; PowerShell currently outweighs it 1.2x. |
