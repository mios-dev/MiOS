...
| Shell / Python / PowerShell / Rust | 41k / 196k / 25k / 20k lines | Law 14 makes Rust the native tier; PowerShell currently outweighs it 1.2x. |
| Drift checks | 208 | Falsifiability audited per check, not assumed. |
