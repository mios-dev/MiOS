...
| Tracked files | 2,913 | The reading surface. |
| Tracked size | 201 MB | Two vendored assets are most of it. |
| Shell / Python / PowerShell / Rust | 41k / 155k / 25k / 20k lines | Law 14 makes Rust the native tier; PowerShell currently outweighs it 1.2x. |
