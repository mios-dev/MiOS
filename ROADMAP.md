...
| Tracked files | 3,380 | The reading surface. |
| Tracked size | 207 MB | Two vendored assets are most of it. |
| Shell / Python / PowerShell / Rust | 50k / 210k / 25k / 31k lines | Law 14 makes Rust the native tier; PowerShell currently outweighs it 0.8x. |
| Drift checks | 220 | Falsifiability audited per check, not assumed. |
| Units reproducing from SSOT | 15 faithful of 210 | 55 registered as drifting: the largest hole in part 1 of the thesis. |
<!-- ROADMAP_METRICS_END -->
