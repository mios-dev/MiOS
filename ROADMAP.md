...
| Tracked files | 3,144 | The reading surface. |
| Tracked size | 203 MB | Two vendored assets are most of it. |
| Shell / Python / PowerShell / Rust | 43k / 202k / 25k / 29k lines | Law 14 makes Rust the native tier; PowerShell currently outweighs it 0.8x. |
