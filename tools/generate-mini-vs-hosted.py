# AI-hint: !/usr/bin/env python3 GENERATES usr/share/doc/mios/reference/mini-vs-hosted.md -- the systematic, surface-by-surface comparison of a MiOS-Mini seat against a ...
...
def render(data: dict) -> str:
    ...
    a("<!-- AI-hint: GENERATED by tools/generate-mini-vs-hosted.py from mios.toml. "
      ...
      "between the two MODES a MiOS-Mini boots into -- seat and full host -- "
      "with every count derived from [blade.archetypes]/[blade.requires]/"
      "[blade].seat_side so the comparison cannot go stale. -->")
