# AI-hint: !/usr/bin/env python3 Sibling unit test for tools/check-schema-consumers.py.
# AI-doc: usr/share/doc/mios/manual/_harvest/tools_test_check_schema_consumers_py.md
