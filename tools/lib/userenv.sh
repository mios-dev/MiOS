...
slots = [
    ...
    ("ports.localai",                  "MIOS_PORT_LOCALAI"),
    ...
    ("services.localai.user",          "MIOS_LOCALAI_USER"),
    ("services.localai.uid",           "MIOS_LOCALAI_UID"),
    ("services.localai.gid",           "MIOS_LOCALAI_GID"),
    ...
    ("services.webui.user",            "MIOS_WEBUI_USER"),
    ("services.webui.uid",             "MIOS_WEBUI_UID"),
    ("services.webui.gid",             "MIOS_WEBUI_GID"),
