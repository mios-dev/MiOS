# AI-hint: !/usr/bin/env bash MIOS_APPLY_CLASS=universal Configures the host's admin sshd to bind to the SSOT port defined in mios.toml by creating a drop-in config in /etc/ss...
# AI-doc: usr/share/doc/mios/manual/_harvest/automation_46_sshd_port_sh.md
set -euo pipefail
