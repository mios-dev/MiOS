...
# automation/tests/test-97-ssot-lint.sh
# ----------------------------------------------------------------------------
# No deps beyond bash + grep + mktemp. Exits 0 if all assertions pass, 1 on
# the first failure. Run standalone:  automation/tests/test-97-ssot-lint.sh
# ----------------------------------------------------------------------------
set -euo pipefail
...
# Build a fixture root: userenv.sh + 34-render-quadlets.sh + one .container.
