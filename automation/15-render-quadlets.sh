...
_render_with_bash() {
    ...
    for var in MIOS_K3S_IMAGE MIOS_CEPH_IMAGE MIOS_FORGE_IMAGE \
               ...
               MIOS_DB_USER MIOS_DB_PASS MIOS_DB_BACKEND MIOS_DB_DATA_DIR; do
        local val="${!var:-}"
