...
_render_with_bash() {
    ...
    for var in MIOS_K3S_IMAGE MIOS_CEPH_IMAGE MIOS_FORGE_IMAGE \
               ...
               MIOS_LLM_LIGHT_IMAGE MIOS_PORT_LLM_LIGHT \
               ...
               MIOS_SGLANG_MEM_FRACTION MIOS_SGLANG_MAX_MODEL_LEN MIOS_SGLANG_TOOL_PARSER; do
        local val="${!var:-}"
