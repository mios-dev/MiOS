...
_render_with_bash() {
    ...
    for var in MIOS_K3S_IMAGE MIOS_CEPH_IMAGE MIOS_FORGE_IMAGE \
               ...
               MIOS_SURREALDB_IMAGE \
               MIOS_PORT_SSH MIOS_PORT_FORGE_HTTP MIOS_PORT_FORGE_SSH \
               MIOS_PORT_COCKPIT MIOS_PORT_COCKPIT_LINK MIOS_PORT_OLLAMA MIOS_PORT_SEARXNG MIOS_PORT_CRAWL4AI \
               MIOS_PORT_FIRECRAWL \
               MIOS_PORT_HERMES MIOS_PORT_OPEN_WEBUI MIOS_PORT_CODE_SERVER MIOS_K3S_API_PORT MIOS_GUACAMOLE_PORT \
               MIOS_CEPH_DASHBOARD_PORT MIOS_RDP_PORT MIOS_PORT_SURREALDB \
               ...
               MIOS_OLLAMA_CPU_USER MIOS_OLLAMA_CPU_UID MIOS_OLLAMA_CPU_GID \
               MIOS_OLLAMA_CPU_IMAGE MIOS_PORT_OLLAMA_CPU \
               ...
               MIOS_LLAMA_SWAP_IMAGE MIOS_PORT_LLAMA_SWAP \
               ...
               MIOS_VLLM_GPU_UTIL MIOS_VLLM_MAX_MODEL_LEN \
               ...
               MIOS_SGLANG_MEM_FRACTION MIOS_SGLANG_MAX_MODEL_LEN; do
        local val="${!var:-}"
