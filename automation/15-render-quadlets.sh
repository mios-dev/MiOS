...
_render_with_bash() {
    ...
    for var in MIOS_K3S_IMAGE MIOS_CEPH_IMAGE MIOS_FORGE_IMAGE \
               MIOS_SEARXNG_IMAGE MIOS_HERMES_IMAGE MIOS_HERMES_WORKSPACE_IMAGE MIOS_CODE_SERVER_IMAGE \
               ...
               MIOS_PORT_HERMES MIOS_PORT_HERMES_WORKSPACE MIOS_PORT_CODE_SERVER MIOS_K3S_API_PORT MIOS_GUACAMOLE_PORT \
