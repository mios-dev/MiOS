#!/usr/bin/env bash
# AI-hint: bash MIOS_APPLY_CLASS=universal Installs FreeIPA and SSSD packages and enables the mios-freeipa-enroll.service; use this script to provision iden...
