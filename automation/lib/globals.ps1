...
$script:MIOS_DOCS_MAX_OVERLONG_HINTS = if ($env:MIOS_DOCS_MAX_OVERLONG_HINTS) { $env:MIOS_DOCS_MAX_OVERLONG_HINTS } else { 424 }
$script:MIOS_DOCS_MAX_UNMIGRATED_NARRATIVE = if ($env:MIOS_DOCS_MAX_UNMIGRATED_NARRATIVE) { $env:MIOS_DOCS_MAX_UNMIGRATED_NARRATIVE } else { 1759 }
