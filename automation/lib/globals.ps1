...
$script:MIOS_VARIANTS_ENTRIES_MIOS_ARTIFACTS = if ($env:MIOS_VARIANTS_ENTRIES_MIOS_ARTIFACTS) { $env:MIOS_VARIANTS_ENTRIES_MIOS_ARTIFACTS } else { 'iso,qcow2,vhdx,bib' }
...
$script:MIOS_VARIANTS_ENTRIES_MIOS_CAT_ARTIFACTS = if ($env:MIOS_VARIANTS_ENTRIES_MIOS_CAT_ARTIFACTS) { $env:MIOS_VARIANTS_ENTRIES_MIOS_CAT_ARTIFACTS } else { 'iso,raw' }
...
$script:MIOS_VARIANTS_ENTRIES_MIOS_METAL_ARTIFACTS = if ($env:MIOS_VARIANTS_ENTRIES_MIOS_METAL_ARTIFACTS) { $env:MIOS_VARIANTS_ENTRIES_MIOS_METAL_ARTIFACTS } else { 'iso,bib' }
