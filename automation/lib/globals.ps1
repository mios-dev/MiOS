...
$script:MIOS_BLADE_PLANES_HA_OWNER = if ($env:MIOS_BLADE_PLANES_HA_OWNER) { $env:MIOS_BLADE_PLANES_HA_OWNER } else { 'mini' }
$script:MIOS_BLADE_PLANES_HA_ROLE = if ($env:MIOS_BLADE_PLANES_HA_ROLE) { $env:MIOS_BLADE_PLANES_HA_ROLE } else { 'Pacemaker/Corosync: places and live-migrates VMs (ADR-0017 D1)' }
...
$script:MIOS_BLADE_PLANES_ORCHESTRATOR_ROLE = if ($env:MIOS_BLADE_PLANES_ORCHESTRATOR_ROLE) { $env:MIOS_BLADE_PLANES_ORCHESTRATOR_ROLE } else { 'k3s: places containers across the fleet (ADR-0017 D1)' }
...
$script:MIOS_BLADE_PLANES_RADIO_ROLE = if ($env:MIOS_BLADE_PLANES_RADIO_ROLE) { $env:MIOS_BLADE_PLANES_RADIO_ROLE } else { 'serves WiFi clients as an access point' }
...
$script:MIOS_BLADE_PLANES_ROUTER_ROLE = if ($env:MIOS_BLADE_PLANES_ROUTER_ROLE) { $env:MIOS_BLADE_PLANES_ROUTER_ROLE } else { 'is the uplink: forwards, NATs and filters for the clients it serves' }
...
$script:MIOS_BLADE_PLANES_STORAGE_ROLE = if ($env:MIOS_BLADE_PLANES_STORAGE_ROLE) { $env:MIOS_BLADE_PLANES_STORAGE_ROLE } else { 'CephFS: the shared filesystem a shed workload keeps its state on' }
