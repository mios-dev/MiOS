...
$script:MIOS_PGVECTOR_IMAGE = if ($env:MIOS_PGVECTOR_IMAGE) { $env:MIOS_PGVECTOR_IMAGE } else { 'docker.io/pgvector/pgvector:pg17' }
...
$script:MIOS_PGVECTOR_VERSION = if ($env:MIOS_PGVECTOR_VERSION) { $env:MIOS_PGVECTOR_VERSION } else { 'docker.io/pgvector/pgvector:pg17' }
