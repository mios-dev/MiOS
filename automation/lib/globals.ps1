...
$script:MIOS_NON_ADDRESSABLE_URL = if ($env:MIOS_NON_ADDRESSABLE_URL) { $env:MIOS_NON_ADDRESSABLE_URL } else { 'adguard_dns,adguard_ui,agent_pipe,arbiter,ceph_dashboard,chrome_cdp,chrome_cdp_worker,cockpit_link,cpu_node,daemon_agent,firecrawl,forge_ssh,guacamole_web,guacd,hermes_dashboard,k3s_api,mcp,model_router,opencode_gateway,oscontrol,otelcol_otlp,prefilter,pxe_hub_api,rdp,redis,sglang,ssh,ttyd_bash,ttyd_powershell,vllm' }
...
$script:MIOS_URLS_NON_ADDRESSABLE = if ($env:MIOS_URLS_NON_ADDRESSABLE) { $env:MIOS_URLS_NON_ADDRESSABLE } else { 'adguard_dns,adguard_ui,agent_pipe,arbiter,ceph_dashboard,chrome_cdp,chrome_cdp_worker,cockpit_link,cpu_node,daemon_agent,firecrawl,forge_ssh,guacamole_web,guacd,hermes_dashboard,k3s_api,mcp,model_router,opencode_gateway,oscontrol,otelcol_otlp,prefilter,pxe_hub_api,rdp,redis,sglang,ssh,ttyd_bash,ttyd_powershell,vllm' }
