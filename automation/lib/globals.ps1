...
$script:MIOS_AI_ENDPOINT = if ($env:MIOS_AI_ENDPOINT) { $env:MIOS_AI_ENDPOINT } else { 'http://localhost:8640/v1' }
...
$script:MIOS_AI_MODEL = if ($env:MIOS_AI_MODEL) { $env:MIOS_AI_MODEL } else { 'default' }
...
$script:MIOS_ENDPOINT = if ($env:MIOS_ENDPOINT) { $env:MIOS_ENDPOINT } else { 'http://localhost:8640/v1' }
...
$script:MIOS_IDENTITY_FULLNAME = if ($env:MIOS_IDENTITY_FULLNAME) { $env:MIOS_IDENTITY_FULLNAME } else { 'MiOS User' }
...
$script:MIOS_MODEL = if ($env:MIOS_MODEL) { $env:MIOS_MODEL } else { 'default' }
...
$script:MIOS_USER_FULLNAME = if ($env:MIOS_USER_FULLNAME) { $env:MIOS_USER_FULLNAME } else { 'MiOS User' }
