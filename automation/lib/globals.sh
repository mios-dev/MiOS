...
: "${MIOS_PORT_CRAWL4AI:=8235}"
: "${MIOS_PORT_HERMES:=8642}"
: "${MIOS_PORT_OPEN_WEBUI:=8033}"
: "${MIOS_PORT_CODE_SERVER:=8800}"
: "${MIOS_PORT_COCKPIT_LINK:=8091}"    # podman-desktop discovery shim
: "${MIOS_K3S_API_PORT:=8443}"
: "${MIOS_GUACAMOLE_PORT:=8080}"       # mios-guacamole web
: "${MIOS_CEPH_DASHBOARD_PORT:=8444}"
: "${MIOS_RDP_PORT:=8389}"             # GNOME Remote Desktop / xRDP
export MIOS_PORT_SSH MIOS_PORT_FORGE_HTTP MIOS_PORT_FORGE_SSH
export MIOS_PORT_COCKPIT MIOS_PORT_LLM_LIGHT MIOS_PORT_PGVECTOR
export MIOS_PORT_SEARXNG MIOS_PORT_CRAWL4AI MIOS_PORT_HERMES MIOS_PORT_OPEN_WEBUI MIOS_PORT_CODE_SERVER MIOS_PORT_COCKPIT_LINK
