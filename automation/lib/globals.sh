...
: "${MIOS_LEGIBILITY_MAX_LIBEXEC_VERBS:=285}"
: "${MIOS_LEGIBILITY_MAX_PS_LINES:=26987}"
: "${MIOS_LEGIBILITY_MAX_SHELL_LINES:=44357}"
: "${MIOS_LEGIBILITY_MAX_TRACKED_FILES:=3344}"
: "${MIOS_LEGIBILITY_MAX_TRACKED_MB:=201}"
...
: "${MIOS_RUST_MAX_UNTESTED_CRATES:=10}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_GENERATE_NAMES_REGISTRY:=generates the names registry; a golden-output test is the obvious shape -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_MIOS_BAKE_PLAN:=454 lines deciding what the bake pulls; wrong output costs a whole build -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_MIOS_COMMENT_LEX:=the comment lexer the docs ratchets measure with -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_MIOS_DRIFT_RUNNER:=runs the drift checks; untested, it can report a pass it did not observe -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_MIOS_SSOT_LINT:=the Rust twin of 97-ssot-lint.sh, asserted byte-identical by a gate but not by its own test -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_MIOS_TEMPLATE_COMPILE:=compiles the templates other surfaces render from -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_MIOS_TEMPLATE_CONFORM:=asserts template conformance and asserts nothing about itself -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_MIOS_VERSION_CHECK:=parses versions by hand; the hand-rolled TOML scan already needed hardening once -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_MIOS_WALLPAPERD:=Windows-only, excluded from the CI workspace build -- AGY-1801}"
: "${MIOS_RUST_UNTESTED_CRATES_TOOLS_NATIVE_XTASK:=a 37-line cargo task helper; the smallest of these and the easiest to cover -- AGY-1801}"
...
: "${MIOS_UNITS_MIOS_NODE_SERVICE_INSTALL_WANTEDBY:=multi-user.target}"
: "${MIOS_UNITS_MIOS_NODE_SERVICE_SERVICE_ENVIRONMENT:=MIOS_AI_ENDPOINT=http://127.0.0.1:8640,MIOS_LOG_LEVEL=info}"
: "${MIOS_UNITS_MIOS_NODE_SERVICE_SERVICE_EXECSTART:=/usr/bin/mios-node 101 8650}"
: "${MIOS_UNITS_MIOS_NODE_SERVICE_SERVICE_LIMITNOFILE:=65536}"
: "${MIOS_UNITS_MIOS_NODE_SERVICE_SERVICE_RESTART:=always}"
: "${MIOS_UNITS_MIOS_NODE_SERVICE_SERVICE_RESTARTSEC:=5s}"
: "${MIOS_UNITS_MIOS_NODE_SERVICE_SERVICE_TYPE:=simple}"
: "${MIOS_UNITS_MIOS_NODE_SERVICE_UNIT_AFTER:=network-online.target,mios-pgvector.service}"
[ -n "${MIOS_UNITS_MIOS_NODE_SERVICE_UNIT_DESCRIPTION+x}" ] || MIOS_UNITS_MIOS_NODE_SERVICE_UNIT_DESCRIPTION='MiOS ('"'"'My OS'"'"') Distributed Edge Micro-Node Runtime Daemon'
: "${MIOS_UNITS_MIOS_NODE_SERVICE_UNIT_DOCUMENTATION:=man:mios-node(1) file:///usr/share/mios/docs/mios_engineering_master_docs.md}"
: "${MIOS_UNITS_MIOS_NODE_SERVICE_UNIT_WANTS:=network-online.target}"
...
: "${MIOS_UNITS_MIOS_XDG_USERDIR_INIT_SERVICE_INSTALL_WANTEDBY:=default.target}"
: "${MIOS_UNITS_MIOS_XDG_USERDIR_INIT_SERVICE_SERVICE_EXECSTART:=/usr/bin/xdg-user-dirs-update --force}"
: "${MIOS_UNITS_MIOS_XDG_USERDIR_INIT_SERVICE_SERVICE_REMAINAFTEREXIT:=yes}"
: "${MIOS_UNITS_MIOS_XDG_USERDIR_INIT_SERVICE_SERVICE_TYPE:=oneshot}"
: "${MIOS_UNITS_MIOS_XDG_USERDIR_INIT_SERVICE_UNIT_CONDITIONPATHISMOUNTPOINT:=%h}"
: "${MIOS_UNITS_MIOS_XDG_USERDIR_INIT_SERVICE_UNIT_DESCRIPTION:=MiOS XDG User Directories Initialization}"
...
: "${MIOS_UNIT_MIOS_NODE_SERVICE_INSTALL_WANTEDBY:=multi-user.target}"
: "${MIOS_UNIT_MIOS_NODE_SERVICE_SERVICE_ENVIRONMENT:=MIOS_AI_ENDPOINT=http://127.0.0.1:8640,MIOS_LOG_LEVEL=info}"
: "${MIOS_UNIT_MIOS_NODE_SERVICE_SERVICE_EXECSTART:=/usr/bin/mios-node 101 8650}"
: "${MIOS_UNIT_MIOS_NODE_SERVICE_SERVICE_LIMITNOFILE:=65536}"
: "${MIOS_UNIT_MIOS_NODE_SERVICE_SERVICE_RESTART:=always}"
: "${MIOS_UNIT_MIOS_NODE_SERVICE_SERVICE_RESTARTSEC:=5s}"
: "${MIOS_UNIT_MIOS_NODE_SERVICE_SERVICE_TYPE:=simple}"
: "${MIOS_UNIT_MIOS_NODE_SERVICE_UNIT_AFTER:=network-online.target,mios-pgvector.service}"
[ -n "${MIOS_UNIT_MIOS_NODE_SERVICE_UNIT_DESCRIPTION+x}" ] || MIOS_UNIT_MIOS_NODE_SERVICE_UNIT_DESCRIPTION='MiOS ('"'"'My OS'"'"') Distributed Edge Micro-Node Runtime Daemon'
: "${MIOS_UNIT_MIOS_NODE_SERVICE_UNIT_DOCUMENTATION:=man:mios-node(1) file:///usr/share/mios/docs/mios_engineering_master_docs.md}"
: "${MIOS_UNIT_MIOS_NODE_SERVICE_UNIT_WANTS:=network-online.target}"
...
: "${MIOS_UNIT_MIOS_XDG_USERDIR_INIT_SERVICE_INSTALL_WANTEDBY:=default.target}"
: "${MIOS_UNIT_MIOS_XDG_USERDIR_INIT_SERVICE_SERVICE_EXECSTART:=/usr/bin/xdg-user-dirs-update --force}"
: "${MIOS_UNIT_MIOS_XDG_USERDIR_INIT_SERVICE_SERVICE_REMAINAFTEREXIT:=yes}"
: "${MIOS_UNIT_MIOS_XDG_USERDIR_INIT_SERVICE_SERVICE_TYPE:=oneshot}"
: "${MIOS_UNIT_MIOS_XDG_USERDIR_INIT_SERVICE_UNIT_CONDITIONPATHISMOUNTPOINT:=%h}"
: "${MIOS_UNIT_MIOS_XDG_USERDIR_INIT_SERVICE_UNIT_DESCRIPTION:=MiOS XDG User Directories Initialization}"
...
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_ARCHETYPE:=endpoint}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_ARTIFACTS:=usb-installer,iso}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_CONFIG:=cat}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_DOC:=usr/share/doc/mios/adr/0008-mios-cat-unified-entry-and-minification.md}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_STATUS:=partial}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_SUMMARY:=the portable edition: a Ventoy USB or NVMe carrying the image, the repository and the models to run, install and deploy with no network}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_TARGET:=removable USB or NVMe}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_TITLE:=MiOS-Cat}"
...
: "${MIOS_VARIANTS_ENTRIES_MIOS_METAL_DOC:=docs/agy/doc-mios-metal.md}"
