...
: "${MIOS_ARTIFACTS_DAILY_OCI_LAYER_ROOT:=usr/share/mios/training/<bundle>/}"
...
[ -n "${MIOS_ARTIFACTS_DAILY_SELF_URL+x}" ] || MIOS_ARTIFACTS_DAILY_SELF_URL='{raw_base}/{branch}/{root_file}'
...
: "${MIOS_ARTIFACTS_DAILY_TASK_CONSUMER:=Gemini Spark}"
: "${MIOS_ARTIFACTS_DAILY_TASK_SCHEDULER:=Google Tasks}"
: "${MIOS_ARTIFACTS_DAILY_TASK_SCHEDULER_ITEM:=Google Task}"
: "${MIOS_ARTIFACTS_DAILY_TEMPLATE:=artifact-prompt}"
[ -n "${MIOS_ARTIFACTS_DAILY_VERDICTS+x}" ] || MIOS_ARTIFACTS_DAILY_VERDICTS='{ meaning = "every ladder rung passed and the bundle, or a no-op report, is attached", role = "submitted", word = "SUBMITTED" },{ meaning = "a check failed; nothing is attached, and every failure names its remediation", role = "rejected", word = "REJECTED" },{ meaning = "a precondition failed: no network, a fetch that did not return 200, or a HEAD that did not resolve", role = "blocked", word = "BLOCKED" }'
...
: "${MIOS_DRIFT_GENERATED_CEILINGS_LEGIBILITY_MAX_SHELL_LINES:=Re-baselined to 48117 following approved merges on main}"
: "${MIOS_DRIFT_GENERATED_CEILINGS_LEGIBILITY_MAX_TOOLING_PYTHON_LINES:=Re-baselined to 77149 following approved merges on main}"
: "${MIOS_DRIFT_GENERATED_CEILINGS_LEGIBILITY_MAX_TRACKED_FILES:=Re-baselined to 3409 following approved merges on main (T-1104..T-1111, manual corpus, devcontainer, artifacts)}"
...
: "${MIOS_LEGIBILITY_MAX_SHELL_LINES:=48117}"
: "${MIOS_LEGIBILITY_MAX_TOOLING_PYTHON_LINES:=77149}"
: "${MIOS_LEGIBILITY_MAX_TRACKED_FILES:=3409}"
: "${MIOS_LEGIBILITY_MAX_TRACKED_MB:=209}"
