...
: "${MIOS_BUILD_LOCAL_TAG:=localhost/mios:latest}"
...
: "${MIOS_HITL_MODE:=log}"
: "${MIOS_HOSTNAME:=codespaces-65e92b}"
...
: "${MIOS_LEGIBILITY_MAX_PS_LINES:=22607}"
: "${MIOS_LEGIBILITY_MAX_SHELL_LINES:=39835}"
: "${MIOS_LEGIBILITY_MAX_TOOLING_PYTHON_LINES:=77019}"
: "${MIOS_LEGIBILITY_MAX_TRACKED_FILES:=3071}"
...
: "${MIOS_USER:=mios}"
: "${MIOS_USER_FULLNAME:=mios-dev}"
: "${MIOS_USER_GROUPS:=wheel,libvirt,kvm,video,render,input,dialout,docker}"
: "${MIOS_USER_HOSTNAME:=codespaces-65e92b}"
: "${MIOS_USER_NAME:=mios-dev}"
