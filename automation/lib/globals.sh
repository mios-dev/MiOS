...
: "${MIOS_AGENTS_AI_LOCAL_KIND:=mobile}"
...
: "${MIOS_LEGIBILITY_MAX_SHELL_LINES:=44498}"
...
: "${MIOS_PODS_MIOS_AI_MEMBERS:=mios-llm-light,mios-cpu-node,mios-llm-worker@,mios-llm-heavy,mios-llm-heavy-alt,mios-pgvector,mios-open-webui,mios-node}"
