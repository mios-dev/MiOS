...
: "${MIOS_LEGIBILITY_MAX_AUTOMATION_PHASES:=75}"
: "${MIOS_LEGIBILITY_MAX_LIBEXEC_VERBS:=267}"
: "${MIOS_LEGIBILITY_MAX_PS_LINES:=22596}"
: "${MIOS_LEGIBILITY_MAX_SHELL_LINES:=40123}"
: "${MIOS_LEGIBILITY_MAX_TOOLING_PYTHON_LINES:=76134}"
: "${MIOS_LEGIBILITY_MAX_TRACKED_FILES:=3134}"
