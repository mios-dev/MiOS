...
: "${MIOS_BUILD_BAKE_FIRSTBOOT_TOKENS:=vllm,sglang}"
: "${MIOS_BUILD_BAKE_GROUPS:=sys,cuda,extra}"
...
: "${MIOS_ENDPOINT:=http://localhost:8640/v1}"
...
: "${MIOS_IDENTITY_FULLNAME:=MiOS User}"
