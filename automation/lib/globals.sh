...
: "${MIOS_PROFILES_FLOOR:=core}"
: "${MIOS_PROFILES_FULL_ALL:=true}"
: "${MIOS_PROFILES_FULL_EXTENDS:=core}"
: "${MIOS_PROFILES_FULL_SUMMARY:=every enabled section and every registered phase}"
: "${MIOS_PROFILES_TARGETS_CLOUD:=dev}"
: "${MIOS_PROFILES_TARGETS_CODESPACE:=dev}"
: "${MIOS_PROFILES_TARGETS_DEVCONTAINER:=dev}"
: "${MIOS_PROFILES_TARGETS_OCI:=full}"
: "${MIOS_PROFILES_TARGETS_WSL2:=full,dev}"
