...
: "${MIOS_PORT_OLLAMA:=11450}"
: "${MIOS_PORT_LLM_LIGHT:=11450}"
: "${MIOS_PORT_PGVECTOR:=5432}"
: "${MIOS_PORT_SEARXNG:=8888}"
: "${MIOS_PORT_CRAWL4AI:=11235}"
: "${MIOS_PORT_HERMES:=8642}"
: "${MIOS_PORT_OPEN_WEBUI:=3030}"
...
export MIOS_PORT_COCKPIT MIOS_PORT_OLLAMA MIOS_PORT_LLM_LIGHT MIOS_PORT_PGVECTOR
