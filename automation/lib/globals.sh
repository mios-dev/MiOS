...
: "${MIOS_VARIANTS_ENTRIES_MIOS_ARTIFACTS:=iso,qcow2,vhdx,bib}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_ARCHETYPE:=endpoint}"
: "${MIOS_VARIANTS_ENTRIES_MIOS_CAT_ARTIFACTS:=iso,raw}"
...
: "${MIOS_VARIANTS_ENTRIES_MIOS_METAL_ARTIFACTS:=iso,bib}"
