...
export MIOS_PORT_SEARXNG MIOS_PORT_HERMES MIOS_PORT_OPEN_WEBUI MIOS_PORT_CODE_SERVER MIOS_PORT_COCKPIT_LINK
...
export MIOS_SEARXNG_URL MIOS_HERMES_URL MIOS_OPEN_WEBUI_URL MIOS_CODE_SERVER_URL
