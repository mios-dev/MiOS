#!/bin/bash
# MiOS v0.1.1 — 99-cleanup: Final image cleanup (mirrors ucore/cleanup.sh)
#
...
#
# v0.1.1: Added targeted lint cleanup for dnf5.log, ldconfig aux-cache,
...
# MiOS v0.1.1: additional lint cleanup based on Cloud Build observations
