...
Installation Details:
  ...
  âœ" Python virtual environment created at .local/share/mios/venv (skipped if python3 absent) at .local/share/mios/venv (skipped if python3 absent) at .local/share/mios/venv (skipped if python3 absent)
