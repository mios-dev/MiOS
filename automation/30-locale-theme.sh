#!/bin/bash
# MiOS v0.1.4 — 30-locale-theme: Unified dark theme for EVERY window type
#
...
# v0.1.4: Delivered via etc/skel/.config/autostart/ overlay.

# Ensure skel GTK3 also uses adw-gtk3-dark (for new user sessions)
# v0.1.4: Delivered via etc/skel/.config/gtk-3.0/settings.ini overlay.
