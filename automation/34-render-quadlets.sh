...
_render_with_bash() {
    ...
    for var in MIOS_SYS_IMAGE MIOS_CUDA_IMAGE MIOS_K3S_IMAGE MIOS_CEPH_IMAGE MIOS_FORGE_IMAGE \
               ...
               MIOS_PORT_FIRECRAWL \
               MIOS_PORT_HERMES MIOS_PORT_HERMES_DASHBOARD MIOS_PORT_AGENT_PIPE MIOS_PORT_OPENCODE_GATEWAY MIOS_PORT_OPEN_WEBUI MIOS_PORT_CODE_SERVER MIOS_PORT_NODE MIOS_PORT_K3S_API MIOS_PORT_GUACAMOLE_WEB \
