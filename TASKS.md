...
| T-316 | P1 | planned | Naming/Addressing | ADDR-01 -- 17 executable retired-port fallbacks; Hermes binds an unassigned port |
...
**Status:** in-progress -- gate reads the SSOT; the probe script and the blade-reachability question remain. | **Domain:** Lifecycle/Health | **Who:** architect
