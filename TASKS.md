...
| T-318 | P1 | planned | Naming/Addressing | ADDR-02 -- Seven sidecar ports were allocated but never bound; the collision check guards numbers nothing uses |
...
**Status:** planned | **Domain:** Naming/Addressing | **Who:** architect
